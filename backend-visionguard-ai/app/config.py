...
VIDEO_FILE_PATH = r"./videos/sample07.mp4"
...
def resolve_device(requested: str | None) -> str:
    ...
    This keeps the app runnable on CPU-only setups (common on Windows) even if
    the environment requests CUDA.
    """
...
DEVICE = resolve_device(os.getenv("DEVICE"))
